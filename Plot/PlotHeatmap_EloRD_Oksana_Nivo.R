...
celltype = c("Naïve CD4+ T-cell","TSCM","CD4+ TCM", 'aCD4+ TCM','aNaïve CD4+ T-cell',"IFN+ CD4+ T-cell",
             "cTreg","eTreg","Th2","TRM","Th17",
             "Naïve CD8+ T-cell","GZMK+ CD8+ T-cell","GZMK+ CCL3+ CCL4+ CD8+ T-cell","GZMH+ GZMB+ CD8+ T-cell","TEMRA")

celltype_factor = c("Naïve_CD4_T_cell","TSCM","CD4_TCM", 'aCD4_TCM','aNaïve_CD4_T_cell',"IFN_CD4_T_cell",
                    "cTreg","eTreg","Th2","TRM","Th17",
                    "Naïve_CD8_T_cell","GZMK_CD8_T_cell","GZMK_CCL3_CCL4_CD8_T_cell","GZMH_GZMB_CD8_T_cell","TEMRA")
