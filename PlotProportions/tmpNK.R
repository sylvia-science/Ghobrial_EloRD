...
marker_counts$idents <- umap_new$cluster[match(rownames(marker_counts), rownames(umap_new))]
...
#marker_means <- marker_means - rowMeans(marker_means)
...
#pdf("Data/NK_Cells/New_Run/Plots/NK_Annotation_Heatmap.pdf", width=12)
